...
`--out-dir reports_custom --title "Анализ пользователей за март" --min-missing-share 0.3`

В результате в каталоге `reports/` появятся:

- `report.md` – основной отчёт в Markdown с указанным заголовком и информацией о новом пороге пропусков;;
